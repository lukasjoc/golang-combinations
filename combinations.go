// Package combinations provides a method to generate all combinations out of a given T array.
...
// Combinations returns combinations of n elements for a given T array.
